...
from dioxide_python_sdk.client.account import DioxAccount, DioxAccountType, DioxAddress, DioxAddressType
...
account_sm2 = DioxAccount.from_json(test_sm2_json, type=DioxAccountType.SM2)
