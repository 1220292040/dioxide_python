...
CORE_CONTRACT_STAKING_GLOBAL = CORE_CONTRACT_REGULATION_GLOBAL + 1
CORE_CONTRACT_ROTATION_GLOBAL = CORE_CONTRACT_REGULATION_GLOBAL + 2
...
CORE_CONTRACT_ROTATION = CORE_CONTRACT_REGULATION + 1
...
def CoreContractIDFromRvm(cid:ContractID):
    ...
    elif ret == CORE_CONTRACT_ROTATION and cid.get_scope() == Scope.Global.value:
        ret = CORE_CONTRACT_ROTATION_GLOBAL
    return ret
